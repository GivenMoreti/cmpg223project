                ...
                <tr>
                    ...
                    <td style="width: 20%;" class="sidebar">
                        ...
                        <div class="div-item">
                            ...
                            <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/OrderConfirmation.aspx">Ordered product</asp:HyperLink>
                        </div>
                        <div class="div-item">
                    ...
                    <td>
                        ...
                        <div class="container-row">
                            ...
                            <div id="productCountContainer">
                                <asp:Label ID="OrderedProductLbl" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
