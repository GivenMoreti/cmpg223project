...
namespace InventoryManagementSystemCMPG223
{
    public partial class GenerateReport : System.Web.UI.Page
    {
        ...
        protected void GenerateReportBtn_Click1(object sender, EventArgs e)
        {
            ...
            ExportToPDF(doc, GetProductData(@"SELECT OP.OrderId,O.CustomerId,O.OrderDate,P.Id 
                AS ProductId,P.ProductName, P.Price, P.ProductDescription, P.ProductSize, OP.Quantity 
FROM  OrderProduct OP INNER JOIN  Orders O ON OP.OrderId = O.OrderId INNER JOIN Products P ON OP.ProductId = P.Id 
ORDER BY O.OrderDate DESC"), "Ordered Products Report");
